...
def resnet34(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet34", BasicBlock, [5, 5, 5], pretrained, progress, **kwargs)
...
def resnet50(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet50", Bottleneck, [5, 5, 5], pretrained, progress, **kwargs)
...
def resnet101(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet101", Bottleneck, [11, 11, 11], pretrained, progress, **kwargs
    )
...
def resnet152(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet152", Bottleneck, [16, 18, 16], pretrained, progress, **kwargs
    )
